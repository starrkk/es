...
<body>
	<div class="container" style="background-color:#f8f8f8">
		...
		<div  style="margin-top:100px;margin-bottom:300px;">
			...
			<form action="<%=getServletContext().getContextPath() %>/grade/show" method="post">
				<div class="row">
					...
					<div class="col-sm-4">
						<div class="row text-center">
							...
							<input type="text" id="id" name="uid"  required oninvalid="setCustomValidity('请输入准考证号')" oninput="setCustomValidity('')" /> 
						</div>
				...
				<div class="row text-center">
					<br><br>
					<input class="btn btn-success" type="submit" style="width:100px" value="查询" /><br>
				</div>
			</form>
		</div>
		<!-- 以下是底部导航栏 -->
